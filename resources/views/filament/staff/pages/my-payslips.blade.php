...
<div style="display:flex;flex-direction:column;gap:16px;">
    ...
    <div style="border-radius:14px;padding:20px 24px;color:#fff;background:linear-gradient(135deg,#10b981,#059669);box-shadow:0 8px 24px rgba(16,185,129,.25);max-width:360px;">
        <div style="font-size:12.5px;opacity:.9;font-weight:600;">Net perçu en {{ $year }}</div>
        ...
        <table style="width:100%;border-collapse:collapse;">
            <thead>
                <tr style="background:#fafbfc;">
                    <th style="text-align:left;padding:13px 22px;font-size:11px;font-weight:600;color:#64748b;text-transform:uppercase;letter-spacing:.5px;">Période</th>
                    <th style="text-align:right;padding:13px 14px;font-size:11px;font-weight:600;color:#64748b;text-transform:uppercase;">Brut</th>
                    <th style="text-align:right;padding:13px 14px;font-size:11px;font-weight:600;color:#64748b;text-transform:uppercase;">CNSS</th>
