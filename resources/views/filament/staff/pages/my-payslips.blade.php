        ...
        <table style="width:100%;border-collapse:collapse;">
            <thead>
                <tr style="background:#fafbfc;">
                    <th style="text-align:start;padding:13px 22px;font-size:11px;font-weight:600;color:#64748b;text-transform:uppercase;letter-spacing:.5px;">{{ __('Période') }}</th>
                    <th style="text-align:end;padding:13px 14px;font-size:11px;font-weight:600;color:#64748b;text-transform:uppercase;">{{ __('Brut') }}</th>
                    <th style="text-align:end;padding:13px 14px;font-size:11px;font-weight:600;color:#64748b;text-transform:uppercase;">{{ __('CNSS') }}</th>
                    <th style="text-align:end;padding:13px 14px;font-size:11px;font-weight:600;color:#64748b;text-transform:uppercase;">{{ __('IRPP') }}</th>
                    <th style="text-align:end;padding:13px 14px;font-size:11px;font-weight:600;color:#64748b;text-transform:uppercase;">{{ __('Net') }}</th>
                    ...
                    <th style="text-align:end;padding:13px 22px;font-size:11px;font-weight:600;color:#64748b;text-transform:uppercase;">PDF</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr style="border-top:1px solid #f1f4f8;">
                    ...
                    <td style="padding:14px 14px;text-align:end;font-size:13px;color:#475569;font-variant-numeric:tabular-nums;">{{ number_format($p['gross'],3) }}</td>
                    <td style="padding:14px 14px;text-align:end;font-size:13px;color:#dc2626;font-variant-numeric:tabular-nums;">-{{ number_format($p['cnss'],3) }}</td>
                    <td style="padding:14px 14px;text-align:end;font-size:13px;color:#dc2626;font-variant-numeric:tabular-nums;">-{{ number_format($p['irpp'],3) }}</td>
                    <td style="padding:14px 14px;text-align:end;font-size:14px;font-weight:800;color:#0f172a;font-variant-numeric:tabular-nums;">{{ number_format($p['net'],3) }}</td>
                    ...
                    <td style="padding:14px 22px;text-align:end;">
