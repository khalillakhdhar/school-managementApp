...
<div style="display:flex;flex-direction:column;gap:18px;">
    ...
    <div style="border-radius:14px;padding:20px 24px;color:#fff;max-width:360px;
        ...
        <div style="font-size:12.5px;opacity:.9;font-weight:600;">{{ __('Solde total dû') }}</div>
                ...
                <tr style="border-top:1px solid #f1f4f8;">
                    ...
                    <td style="padding:12px 22px;text-align:center;">
                        <span style="font-size:11px;font-weight:700;padding:3px 10px;border-radius:7px;
                            ...
                            {{ ['paid'=>__('Payé'),'pending'=>__('En attente'),'overdue'=>__('En retard')][$p['status']] }}
                        </span>
                    </td>
                </tr>
                @empty
                <tr><td colspan="4" style="padding:24px;text-align:center;color:#94a3b8;font-size:13px;">{{ __('Aucun paiement enregistré.') }}</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
